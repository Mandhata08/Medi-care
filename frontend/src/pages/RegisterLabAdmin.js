...
function RegisterLabAdmin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/api/auth/register/LAB_ADMIN/', formData);
      ...
      <Container maxWidth="sm">
        <Paper elevation={10} sx={{ padding: { xs: 3, sm: 4 }, width: '100%', borderRadius: 3 }}>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            <Typography component="h1" variant="h4" gutterBottom sx={{ fontWeight: 'bold', color: '#1976d2' }}>Register as Lab Admin</Typography>
            <Typography variant="body2" color="textSecondary">Manage your diagnostic lab</Typography>
          </Box>
...
export default RegisterLabAdmin;
